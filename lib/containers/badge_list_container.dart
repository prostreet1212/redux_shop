...
class BadgeConnector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, _ViewModel>(
      ...
      builder: (context, vm) {
        return BadgeListWidget(badgeList: vm.badgeList,clearBadge: vm.onClearBadge,changeBuyStatus: vm.onChangeBuyStatus,);
      },
    );
  }
}
...
class _ViewModel {
  ...
  _ViewModel({required this.badgeList,required this.onClearBadge,required this.onChangeBuyStatus});
